...
def genImage(word_a="5000兆円", word_b="欲しい!", default_width=1500, height=500,
    ...
    font_downer = ImageFont.truetype(downer_font_path, _round(height*0.37*k)+ upmargin)
    ...
    # finish
    previmg = Image.new("RGBA", (max([upper_width, downer_width]) + leftmargin + subset + 100, height + upmargin + 30), (255,255,255,0))
    ...
    if upper_width> downer_width+subset:
        previmg.alpha_composite(tiltres[1], (upper_width + subset - downer_width, _round(height/2) + 15), (0, 0))
    else:
