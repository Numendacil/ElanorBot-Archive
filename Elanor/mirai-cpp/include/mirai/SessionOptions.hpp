...
namespace Cyan
{
	...
	public:
		...
		*/
		...
		/**
		 * @brief Hostname (WebSocket 适配器), 默认值为 localhost.
		*/
		Property<string> WebSocketHostname = "localhost"s;

		/**
		 * @brief Http Read Timeout (Http 适配器, 单位秒), 默认值为 60.
		*/
		Property<long> HttpReadTimeout = 60;

		/**
		 * @brief Http Write Timeout (Http 适配器, 单位秒), 默认值为 60.
		*/
		Property<long> HttpWriteTimeout = 60;
